...
import { listPosts, getUsersList, getUserPost, getNewPosts } from "../controllers/timeline.controller.js";
...
timelineRouter.get("/timeline/new-posts/:postId", validateAuth, getNewPosts);
